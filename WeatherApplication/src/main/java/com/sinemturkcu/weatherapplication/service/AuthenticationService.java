...
import com.sinemturkcu.weatherapplication.enums.TokenType;
...
public class AuthenticationService {
    ...
    public AuthenticationResponse authenticate(AuthenticationRequest request) {
        logger.info("User authentication request received for email: {}", request.getEmail());
    ...
    public void refreshToken(
        ...
        if (userEmail != null) {
            ...
            if (jwtService.isTokenValid(refreshToken, user)) {
                ...
                logger.info("Refreshed access token for user: {}", userEmail);
            }
        }
    }
}
